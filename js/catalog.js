...
function populateForm() {
  ...
  var selectedItem = document.createElement('option');
  selectedItem.setAttribute('value', Product.allProducts[i].name);
  selectedItem.textContent = Product.allProducts[i].name;
...
function updateCartPreview() {
  ...
  var cartItem = new CartItem(itemsValue, quantityValue);
